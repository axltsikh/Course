...
<div class="menu">
    ...
    <div class="info">Посвящается Алексею
         Леонидовичу
          Пажитнову</div>
</div>
<div class="field">
...
<canvas id="can" class="container2" width="250" height="500"></canvas>

<div class="start">
    <div class="score">Score:<span id="score"></span></div>
    <div class="lines">Lines:<span id="lines"></span></div>
